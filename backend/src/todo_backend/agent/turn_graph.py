...
class AssistantTurnWorkflow:
    ...
    def _plan_intent(self, state: AssistantTurnState) -> AssistantTurnState:
        ...
        try:
            ...
            validate_explicit_actions(user_message.content, plan)
        except PlanValidationError as error:
            return self._planning_failure(error.code)
        except PlanPolicyError as error:
            return self._planning_failure(str(error))
        return {
    ...
    def _execute_read(self, state: AssistantTurnState) -> AssistantTurnState:
        ...
        return {"response_text": result.content, "error_code": None}
            ...
            "proposals": [
                {
                    ...
                    "payload": proposal.payload.model_dump(
                        mode="json", by_alias=True
                    ),
        ...
        for item in raw_proposals:
            ...
            proposals.append(
                ProposalDraft(
                    ...
                    payload=ProposalCardFields.model_validate(payload_raw),
