...
const zhCN = {
  ...
  'time.previousMonth': '上个月', 'time.nextMonth': '下个月', 'time.today': '今天', 'time.point': '时间点',
...
const en: Record<TranslationKey, string> = {
  ...
  'time.previousMonth': 'Previous month', 'time.nextMonth': 'Next month', 'time.today': 'Today', 'time.point': 'Single time',
